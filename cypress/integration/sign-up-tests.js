describe('Checkout Test Suits', () => {
    it('test case 1 -> able to signed up, logged in, and log out', () => {
      ...
      cy.get('#signup-firstname').type('12345689', { delay: 5})
      cy.get('#signup-lastname').type('12345689', { delay: 5})
      cy.get('#signup-contactNo').type('9123456789', { delay: 5})
      cy.get('#signup-email').type('1234689@gmail.com', { delay: 5})
      cy.get('#signup-password').type('123456', { delay: 5})
      cy.get('#signup-street').type('123456', { delay: 5})
      cy.get('#signup-city').type('123456', { delay: 5})
      cy.get('#signup-province').type('123456', { delay: 5})
